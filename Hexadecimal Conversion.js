...
console.log(Object.getOwnPropertyDescriptor(digits, indexNum));

// let mataMare = (value) => {
//     for(let prop in digits) {
//         if(digits.hasOwnProperty(prop)) {
//             if(digits[prop] === value) {
//                 return prop;
//             }
//         }
//     }
